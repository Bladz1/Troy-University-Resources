...
c. Suppose Bank A lends out all their excess reserve to Giang. What will be the amount of the loan?  
...
a. Find $\text{M}^\text{D}$ for $\text{r} = 10$% and $\text{r} = 5$%?  
b. What is the relationship between $\text{r}$ and $\text{M}^\text{D}$?  
c. Graph $\text{M}^\text{S}$ and $\text{M}^\text{D}$ and calculate the equilibrium $\text{i}$?  
d. Cetral Bank decreases $\text{M}^\text{S}$ by 50. What happens to money market equilibrium? (solve & graph)  
e. Describe how the Central Bank changes interest rate in the macroeconomy.  
